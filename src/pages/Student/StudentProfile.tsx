...
const StudentProfile = () => {
  ...
  //               <span className="text-sm font-medium text-white">{studentData.currentStreak} day streak</span>
  //             </div>

  //             <Avatar className="h-8 w-8">
  //               <AvatarImage src={studentData.avatar} alt={studentData.firstName} />
  //               <AvatarFallback>{studentData.firstName}</AvatarFallback>
  //             </Avatar>
  //           </div>
  //         </div>
  //       </div>
  ...
  //                   </Avatar>
  //                   <div>
  //                     <h3 className="text-lg font-semibold">{studentData.firstName}</h3>
  //                     <div className="bg-gradient-primary px-2 py-1 rounded-full">
  //                       <span className="text-xs font-medium text-white">{studentData.grade}</span>
  //                     </div>
  //                   </div>
  //                 </div>
  ...
  //                     {/* <span className="text-sm">/{studentData.school}</span> */}
  //                     <span className="text-sm">UPSS</span>
  //                   </div>
  //                   <div className="flex items-center space-x-3">
  //                     <CalendarDays className="h-4 w-4 text-muted-foreground" />
  //                     <span className="text-sm">Joined {studentData.createdAt}</span>
  //                   </div>
  //                 </div>
  //               </CardContent>
  //             </Card>
  ...
  //                   </div>
  //                   <div>
  //                     <div className="text-3xl font-bold bg-gradient-primary bg-clip-text text-transparent">{studentData.currentStreak}</div>
            ...
            <nav className="space-y-2">
              {sidebarItems.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
                  className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-all duration-300 hover:shadow-md ${item.active
                    ? "bg-gradient-primary text-white font-medium shadow-glow"
                    : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
                    }`}
                >
